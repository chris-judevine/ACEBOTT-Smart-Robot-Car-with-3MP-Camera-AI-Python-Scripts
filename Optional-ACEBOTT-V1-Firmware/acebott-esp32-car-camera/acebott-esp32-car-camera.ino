...
void setup() {
  ...
  webServer.on("/control", []() {
	...
	if (cmd == "car-auto-stop") {
      String direction = webServer.arg("direction");
      // 0x0E is our new custom command for Auto-Stop mode
      data = { 0xFF, 0x55, 0x0A, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x0E, 0x00 };
      if (direction == "Forward") { data.push_back(0x01); }
      else if (direction == "Backward") { data.push_back(0x02); }
      else if (direction == "Left") { data.push_back(0x03); }
      else if (direction == "Right") { data.push_back(0x04); }
      else if (direction == "Anticlockwise") { data.push_back(0x09); }
      else if (direction == "Clockwise") { data.push_back(0x0A); }
      else if (direction == "stop") { data.push_back(0x00); }
      else if (direction == "LeftUp") { data.push_back(0x05); }
      else if (direction == "RightUp") { data.push_back(0x07); }
      else if (direction == "LeftDown") { data.push_back(0x06); }
      else if (direction == "RightDown") { data.push_back(0x08); }
    }
